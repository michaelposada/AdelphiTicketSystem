				...
				<div id="login">
						<p style = "font-family:georgia,garamond,serif;font-size:16px;font-style:italic;">
							<center>
									...
									$result = pg_query($dbh, "SELECT username FROM adminm WHERE adminid = " .$userid.  "");
								?>
								...
								<div class="row">
									<div class="column">
										...
										<table id="searchTable">
											...
											if(array_key_exists('submitSearch',$_POST))
											{
												...
												$result = pg_query($dbh, "SELECT * FROM tickets WHERE(adminid ='".$userid."' AND ".$tag." = '".$search."')");
										...
										<?php
                									...
                									$userid = $_SESSION['userid'];
                									$result = pg_query($dbh, "SELECT * FROM tickets WHERE adminid = " .$userid.  "");
                									$i = pg_num_fields($result);
                									if (!$result)
                									{
                        									echo "An error occurred.\n";
									...
									----------------------------------------------------------------------------------------------------------------
	<h3 class="title" style = "font-size:20px">Resolve Ticket.</h3> 
										<div align="left" style="padding-left: 100px">
										<form action="addTicket.php" method="post">
											...
											<br> <br>                                                               
											<input type="submit" name="editTicket2" formaction="addTicket.php" value="Confirm edit">							
										</form>
									</div>
							</center> 
						</p>
